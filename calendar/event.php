...
//   $mysqli = mysqli_connect("localhost", "testuser", "somepass", "testDB") or die('Not connected : Ah sh*t ' . mysqli_connect_error()); 
 $host="localhost";
 $user="root";
 $passward="";
 $db="calender_event";
 
  $mysqli= mysqli_connect("localhost", "root", "", "calender_event") or die('Not connected : Ah sh*t ' . mysqli_connect_error());
 if($mysqli===false)
 {
